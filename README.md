...
1. Set up developer mode for Chrome Extensions (see [here](https://developer.chrome.com/extensions/faq#faq-dev-01))
1. Navigate in Chrome to [chrome://extensions/](chrome://extensions/)
